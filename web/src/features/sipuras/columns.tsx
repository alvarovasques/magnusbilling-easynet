...
export const sipurasColumns: ColDef<Sipuras>[] = [
  { field: 'macadr', headerName: 'MAC', minWidth: 150, pinned: 'left', filter: true },
  // idUserusername é extraValue de relação (idUser->username): NÃO filtrar.
  { field: 'idUserusername', headerName: 'Cliente', minWidth: 150 },
  { field: 'marca', headerName: 'Marca', minWidth: 100, filter: true },
  { field: 'User_ID_1', headerName: 'Linha 1', minWidth: 120, filter: true },
  { field: 'last_ip', headerName: 'Último IP', minWidth: 130, filter: true },
  ...
  { field: 'fultmov', headerName: 'Últ. movimento', minWidth: 160, filter: true },
];
