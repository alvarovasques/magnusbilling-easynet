...
export const trunkColumns: ColDef<Trunk>[] = [
  { field: 'trunkcode', headerName: 'Tronco', minWidth: 160, pinned: 'left', filter: true },
  ...
  { field: 'providertech', headerName: 'Tecnologia', minWidth: 120, filter: true },
  { field: 'host', headerName: 'Host', minWidth: 140, filter: true },
